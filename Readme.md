...
## J: Henri Poincaré and Alternative Geometries
...
* **Concept:** Uses simple, everyday mental exercises ("expériences quotidiennes") proposed by Roger-Pol Droit to shift perspective and question the solidity of reality or the nature of time.
* **Scenario 1 (Time):** Imagine the world only lasts 20 minutes – it popped into existence moments ago and will vanish shortly. How does this change perception? 
...
* **Concept:** Demonstrates the principle of relativity for uniform motion – that the laws of physics are the same in all inertial (non-accelerating) reference frames.
